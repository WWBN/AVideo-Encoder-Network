...
Provide the final Streamer URL and administrator credentials. Verification uses the Streamer encoded-password protocol and checks TLS certificates. Enter one initial Encoder URL per line; blank lines and duplicates are ignored. You can add more Encoders after installation.
